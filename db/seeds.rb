...
Shop.create(name: 'Thinking Cup', address: '165 Tremont St, Boston, MA 02111',
           description: 'Amazing iced coffee and great baked goods. No WIFI though!')

Shop.create(name: 'Flat Black Coffee', address: '50 Broad St, Boston, MA 02109',
           description: 'Fun little coffee shop!')

Shop.create(name: 'Render Coffee', address: '563 Columbus Ave, Boston, MA 02118',
           description: 'Great coffe and sandwiches! In the back of the shop, there is a room that has a domed glass roof! super cool!')
...
Shop.create(name: 'Capitol Coffee House', address: '122 Bowdoin St, Boston, MA 02108',
           description: 'Super cute coffee shop! The coffee is great as well as the food!')

Shop.create(name: 'Caffe Vittoria', address: '290 Hanover St, Boston, MA 02113',
           description: 'Amazing little coffee shop in the heart of the north end!')

Shop.create(name: 'Pavement Coffeehouse', address: '1096 Boylston St, Boston, MA 02215',
           description: 'Rustic, cozy joint with tall ceilings & leather banquettes serving artisan coffee, teas & bagels.')

Shop.create(name: 'Caffe Paradiso', address: '255 Hanover St, Boston, MA 02113',
           description: 'Locals head to this traditional Italian coffeehouse for espresso, gelato, pastries & socializing.')

Shop.create(name: 'Equal Exchange Cafe', address: '226 Causeway St, Boston, MA 02114',
           description: 'Cozy coffee shop bringing together drinks sourced from a local co-op & a veggie-heavy food menu.')
